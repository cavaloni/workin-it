...
var toSubscriber_1 = __webpack_require__(240);
...
var _find = __webpack_require__(206);

var _find2 = _interopRequireDefault(_find);

var _difference = __webpack_require__(205);

var _difference2 = _interopRequireDefault(_difference);

var _uniq = __webpack_require__(220);

var _uniq2 = _interopRequireDefault(_uniq);

var _setWith = __webpack_require__(217);
...
var _inRange = __webpack_require__(211);
...
var _camelCase = __webpack_require__(201);

var _camelCase2 = _interopRequireDefault(_camelCase);

var _flatten = __webpack_require__(208);
...
var _ex_model = __webpack_require__(50);

var _ex_model2 = _interopRequireDefault(_ex_model);

var _user_model = __webpack_require__(51);
...
function getExerciseData(req, res) {
    ...
    _ex_model2.default.findOne({
        ...
        allUserData = data;
        if ((0, _isEmpty2.default)(allUserData)) {
            res.status(201).json({
                data: 'no data'
            });
        } else {
            ...
            if ((0, _isEmpty2.default)(exerciseData)) {
                ...
                userRangeData = Object.keys(exerciseData).filter(function (years) {
                    ...
                    return (0, _inRange2.default)(weeks, weekRangeMin, weekRangeMax);
...
router.put('/', function (req, res) {
    ...
    _ex_model2.default.findOne({
        ...
        var newData = (0, _cloneDeep2.default)(prevData);
        ...
        req.body.dataToSave.forEach(function (data) {
            ...
            var camelName = (0, _camelCase2.default)(req.body.dataToSave[i].exercise);
            var exGroup = req.body.dataToSave[i].exerciseGroup;
            exercisesInDataToSave.push(camelName);

            newData = (0, _setWith2.default)(newData, 'exerciseData.' + year + '.' + week + '.' + exGroup + '.' + camelName + '.data', exSets, Object);
            newData = (0, _setWith2.default)(newData, 'exerciseData.' + year + '.' + week + '.' + exGroup + '.' + camelName + '.sets', numSets, Object);
            newData = (0, _setWith2.default)(newData, 'exerciseData.' + year + '.' + week + '.' + exGroup + '.' + camelName + '.fullName', exName, Object);
        });
        ...
        var exercisesInDatabase = (0, _uniq2.default)((0, _flatten2.default)(Object.keys(newData.exerciseData[year][week]).map(function (exGroup) {
            return Object.keys(newData.exerciseData[year][week][exGroup]).map(function (exercise) {
                return exercise;
            });
        })));
        var exercisesToDelete = (0, _difference2.default)(exercisesInDatabase, exercisesInDataToSave);
...
router.post('/get_friend_data', function (req, res) {
    ...
    _user_model.User.findOne({
        ...
        _user_model.User.findOne({
            ...
            var userStatusOfFriend = (0, _find2.default)(userProfile.friends, function (friend) {
                return friend.fbId === friendFbId;
            }).status;
            var friendStatusOfUser = (0, _find2.default)(friendProfile.friends, function (friend) {
...
var _exercisesList = __webpack_require__(95);
...
var exercisesList = Object.keys(listToJS).reduce(function (acc, cur) {
    var currentExercise = (0, _capitalize2.default)(cur);
...
var baseSlice = __webpack_require__(131);
...
var addSetEntry = __webpack_require__(101),
    arrayReduce = __webpack_require__(34),
    setToArray = __webpack_require__(20);
...
var castSlice = __webpack_require__(135),
    hasUnicode = __webpack_require__(73),
...
var asciiToArray = __webpack_require__(106),
    hasUnicode = __webpack_require__(73),
...
var capitalize = __webpack_require__(79),
    createCompounder = __webpack_require__(148);
...
var baseDifference = __webpack_require__(112),
    ...
    baseRest = __webpack_require__(128),
    isArrayLikeObject = __webpack_require__(212);
...
var baseInRange = __webpack_require__(114),
    toFinite = __webpack_require__(83),
...
var toFinite = __webpack_require__(83);
...
var baseUniq = __webpack_require__(134);
...
var createCaseFirst = __webpack_require__(147);
...
var asciiWords = __webpack_require__(107),
    hasUnicodeWord = __webpack_require__(159),
    toString = __webpack_require__(12),
    unicodeWords = __webpack_require__(200);
...
var isArray_1 = __webpack_require__(236);
var isObject_1 = __webpack_require__(90);
var isFunction_1 = __webpack_require__(89);
var tryCatch_1 = __webpack_require__(241);
var errorObject_1 = __webpack_require__(88);
var UnsubscriptionError_1 = __webpack_require__(235);
/**
...
var Observable_1 = __webpack_require__(6);
var concatAll_1 = __webpack_require__(231);
...
var Observable_1 = __webpack_require__(6);
var map_1 = __webpack_require__(232);
...
var mergeAll_1 = __webpack_require__(233);
...
var OuterSubscriber_1 = __webpack_require__(224);
...
var root_1 = __webpack_require__(7);
var isArrayLike_1 = __webpack_require__(237);
var isPromise_1 = __webpack_require__(238);
var isObject_1 = __webpack_require__(90);
var Observable_1 = __webpack_require__(6);
...
var Strategy = __webpack_require__(93).Strategy;
var jwt = __webpack_require__(48);
var eJwt = __webpack_require__(27);
var shortid = __webpack_require__(94);
...
app.get('/demo', function (req, res) {
    ...
    var token = jwt.sign(profile, SECRET1, { // eslint-disable-line
        expiresIn: 10,
...
app.get('/new_token', eJwt({ secret: SECRET1,
    ...
    var newToken = jwt.sign({ user: user }, SECRET2, { expiresIn: '7 days' });
